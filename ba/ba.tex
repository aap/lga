...
uridg. \rek{str̥tós}: att. στρατός, lesb. boiot. στροτός `Truppe'
...
\mypara{el. \rek{ē} > \rek{ā}}

Im Elischen ist \rek{ē} als \bel{ā} wiedergegeben.
...
(σεμνός < \rek{sebnós} < \rek{ti̯egʷnós})
