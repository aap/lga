...
\input{$HOME/sprachen/griechisch/greektokens.tex}
...
uridg. \rek{k̑}: \rek{k̑m̥tóm} > gr. ἑκατόν; ai. \bel{śatáṃ} `hundert'

uridg. \rek{k}: \rek{leu̯kós} > gr. λευκός; ai. \bel{rocás} `leuchtend'

uridg. \rek{g̑}: \rek{h₂ég̑onti} > att. ἄγουσι; av. \bel{azənti} `sie führen'

uridg. \rek{g}: \rek{gerh₂nós} > gr. γερανός; cf. lit. \bel{gervė} `Kranich'

uridg. \rek{g̑ʰ}: zu \rek{u̯eg̑ʰ-/u̯og̑ʰ-}: att. ὄχος `Wagen'; av. \bel{vazāmi} `ich fahre'

uridg. \rek{gʰ}: \rek{h₃migʰ-/h₃moi̯gʰ-}: gr. ὀμίχλη `Nebel'; ai. \bel{meghás} `Wolke'
...
uridg. \rek{k̑þ}: \rek{ték̑þō(n)} > gr. τέκτων; ai. \bel{tákṣā} `Zimmermann'

\lex{\i{þ}}{\i{dʰ}}{\{Media asp.\}\_}

uridg. \rek{gʷʰþ}: \rek{ń̥gʷʰþitom} > gr. ἄφθιτον; ai. \bel{ákṣitam} `unvergänglich'
...
uridg. \rek{bʰ}: \rek{bʰéronti} > dor. φέροντι; ai. \bel{bháranti} `sie tragen'
...
uridg. \rek{gʷʰ}: zu \rek{gʷʰen-}: gr. φόνος `Mord'; ai. \bel{gʰnánti} `sie erschlagen'
...
uridg. \rek{i̯-}: \rek{i̯ugóm} > gr. ζυγόν; ai. \bel{yugám} `Joch'
...
uridg. \rek{trí-h₂} > gr. τρία; ai. \bel{trī́} `drei'

\lex{\i{(i, u)H}}{\i{(i̯, u̯)V}}{\i{C}\_\#} (Rix §85b)

uridg. \rek{h₃ókʷ-ih₁} > \rek{okʷi̯e} > hom. ὄσσε `beide Augen'

uridg. \rek{dóru-h₂} > \rek{dóru̯a} > hom. δοῦρα `Speere'
...
uridg. \rek{o/eh₂}: zu \rek{bʰoh₂-}/\rek{bʰeh₂-}: dor. φωνᾱ́ `Stimme' bzw. φᾱτί `spricht'
...
uridg. \rek{h₁r-}: \rek{h₁regʷos} > gr. ἔρεβος `Finsternis'; ai. \bel{rájas} `Dunst'
...
uridg. \rek{h₁n̥}: zu \rek{dʰidʰh₁-n̥t-}: gr. τιθέ-ντ-ος; ai. \bel{dádh-at-as}

uridg. \rek{h₃n̥}: zu \rek{didh₃-n̥t-}: gr. διδό-ντ-ος; ai. \bel{dád-at-as}
...
\lex{\i{Ŕ̥H}}{\i{V́RV}}{\_\i{C}}

uridg. \rek{ń̥h₁}: \rek{g̑ń̥h₁tis} > gr. γένεσις `Erzeugung'

uridg. \rek{ŕ̥h₂}: \rek{k̑ŕ̥h₂sn̥h₂} > \rek{kárasna} > hom. κάρηνα `Köpfe'
...
\lex{\i{kʷ}, \i{gʷ}, \i{kʷʰ}}{\i{k}, \i{g}, \i{kʰ}}{(\i{u}, \i{ū}, \i{u̯})\_; \_(\i{u}, \i{ū}, \i{}u̯, \i{i̯})}
...
\rek{\#sr}: zu uridg. \rek{sreu̯-}: gr. ῥέω; ai. \bel{srávati} `es fließt'
...
\rek{krini̯ō} > ion-att. κρῑ́νω, lesb. κρίννω `ich entscheide'
...
uridg. \rek{mr̥tós} > aiol. βροτός `Sterblicher'; ai. \bel{mṛtás} `tod'

\rek{ml̥h₃sk̑oh₂} > βλώσκω `ich komme' zu μολεῖν `kommen'

\lex{\i{NR}}{\i{NDR}}

uridg. \rek{h₂n̥rós} > \rek{anrós} > ἀνδρός G.Sg. zu ἀνήρ `Mann'
...
uridg. \rek{upo} > gr. ὑπό; ai. \bel{úpa} `unter'
...
wie att. ἴσος < \rek{u̯itsu̯os} `vielleicht' und δεσπότης < \rek{dems-pótās} `Hausherr' zeigen,
...
\rek{au̯i̯etós} > αἰβετός (Hesychglosse), hom. αἰετός `Adler'
...
uridg. \rek{áli̯os} > kypr. αἶλος, sonst ἄλλος; lat. \bel{alius} `ein anderer'
...
mit alten \bel{ē}, \bel{ō} zusammen.
...
\lex{(\i{e}, \i{i}, \i{u})\i{ŔŔ}}{(\i{ẹ̄}, \i{ī}, \i{ū})\i{R}} (mit \i{Ŕ} = \i{ŕ}, \i{ń}, \i{ẅ})
...
\rek{u̯εspérā} > att. ἑσπέρᾱ `Abend'; cf. lat. \bel{vesper}
...
\lex{\i{ǣ}}{\i{ā}}{(\i{e}, \i{ē}, \i{ẹ̄}, \i{i̯}, \i{i}, \i{ī}, \i{r})\_}
...
Die Dissimilation \rek{-tʰē-tʰi} > -θη-τι im Imp.2.Sg.Aor.Pass.
...
aber wie Lejeune mit ὄφρα < \rek{i̯ópʰra} (cf. Stamm des Relativums \rek{i̯o-})
`bis; damit' zeigt,
