...
\tt{(irregex-replace/all "(foo)(bar)" 2 (lambda (m)
...
Will man bswp. ein Lautgesetz \tt{(s "b" "p")} formulieren,
so hätte dies die Nebenwirkung,
dass auch \tt{bʰ} zu \tt{pʰ} würde,
was im allgemeinen Fall unerwünscht ist.
Wenn man Laute wie \tt{bʰ} oder \tt{gʷ} mit einem einzigen Codepoint
